-- 1. Create user_characters table if it does not exist
...
-- 2. Enable RLS on user_characters
...
-- 5. Secure RPC Function to process opening a mystery box
...
-- 6. Secure RPC Function to upgrade a character
