...
import { convertToDisplayCurrency, formatCurrencyAmount } from '@/utils/currencyUtils';
      ...
      <div className="bg-secondary p-4 rounded-xl mb-6">
        <div className="flex justify-between items-center">
          ...
          <span className="text-2xl font-bold">
            {formatCurrencyAmount(convertToDisplayCurrency(cashAvailable, currencyDisplay), currencyDisplay)}
          </span>
        </div>
        <div className="text-xs text-muted-foreground mt-1">
          2 points = {formatCurrencyAmount(convertToDisplayCurrency(1, currencyDisplay), currencyDisplay)}
        </div>
      </div>
