...
export const defaultSuccessMessages: FunMessage[] = [
  ...
  { id: '6', type: 'success', text: "Your brain deserves a trophy! 🏆", emoji: '🏆', createdAt: new Date().toISOString(), isActive: true },
  { id: '7', type: 'success', text: "High five to your genius! ✋", emoji: '✋', createdAt: new Date().toISOString(), isActive: true },
  { id: '8', type: 'success', text: "Quiz master in the house! 🏠", emoji: '🏠', createdAt: new Date().toISOString(), isActive: true },
  { id: '9', type: 'success', text: "That's what I call smart! 📚", emoji: '📚', createdAt: new Date().toISOString(), isActive: true },
  { id: '10', type: 'success', text: "You're absolutely brilliant! ✨", emoji: '✨', createdAt: new Date().toISOString(), isActive: true },
];
...
export const defaultFailureMessages: FunMessage[] = [
  ...
  { id: '6', type: 'failure', text: "Don't worry, learning happens in mistakes! 🌱", emoji: '🌱', createdAt: new Date().toISOString(), isActive: true },
  { id: '7', type: 'failure', text: "Close one! Your brain is still awesome! 🧩", emoji: '🧩', createdAt: new Date().toISOString(), isActive: true },
  { id: '8', type: 'failure', text: "Whoopsie daisy! Next one's yours! 🌼", emoji: '🌼', createdAt: new Date().toISOString(), isActive: true },
  { id: '9', type: 'failure', text: "The road to wisdom has speed bumps! 🛣️", emoji: '🛣️', createdAt: new Date().toISOString(), isActive: true },
  { id: '10', type: 'failure', text: "Every mistake makes your brain stronger! 💪", emoji: '💪', createdAt: new Date().toISOString(), isActive: true },
];
...
export const defaultAchievementMessages: FunMessage[] = [
  ...
  { id: '4', type: 'achievement', text: "Quiz champion badge earned! 🎖️", emoji: '🎖️', createdAt: new Date().toISOString(), isActive: true },
  { id: '5', type: 'achievement', text: "Your knowledge tree is growing! 🌳", emoji: '🌳', createdAt: new Date().toISOString(), isActive: true },
];
...
export const defaultWelcomeMessages: FunMessage[] = [
  ...
  { id: '4', type: 'welcome', text: "Knowledge adventure begins now! 🚀", emoji: '🚀', createdAt: new Date().toISOString(), isActive: true },
  { id: '5', type: 'welcome', text: "Buckle up for a brain-boosting ride! 🎢", emoji: '🎢', createdAt: new Date().toISOString(), isActive: true },
];
...
export const defaultLevelUpMessages: FunMessage[] = [
  ...
  { id: '4', type: 'level_up', text: "Knowledge power increased! Keep going! 📈", emoji: '📈', createdAt: new Date().toISOString(), isActive: true },
  { id: '5', type: 'level_up', text: "Your quiz ranking just skyrocketed! 🚀", emoji: '🚀', createdAt: new Date().toISOString(), isActive: true },
];
